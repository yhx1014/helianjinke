...
<div class="wrapper wbgcolor">
    <div class="w1200 personal">
        ...
        <div class="personal-main">
          ...
          <i class="c-pink"><fmt:formatNumber value="${gm == null ? '0.00' : gm }" pattern="#.##"/></i> 元 </span> <span><b
                        class="fb">待收本金</b><br/>
          <i><fmt:formatNumber value="${tm == null && thm == null ? '0.00' : (tm - thm)}" pattern="#.##"/></i> 元 </span>
                    <span class="none"><b class="fb">待收收益</b><br/>
          <i><fmt:formatNumber value="${gtm == null && gm == null ? '0.00' : (gtm - gm)}" pattern="#.##"/></i> 元 </span>
                </div>
            	...
            	<c:forEach items="${record }" var="recordList" varStatus="idnum">
              		<li>
              			<span class="investnote-w1"
                              title="${recordList.title }">${ft:substring(recordList.title,0,8) }</span>
					...
					<li>
						...
						<c:forEach begin="1" end="${totalpage > 6 ? 6 : totalpage}" step="1"
                                   varStatus="bindex">&nbsp;<a class="curr" onclick="" href="investRecord.do?currpage=${bindex.count }">${bindex.count }</a>
                        </c:forEach><a href="investRecord.do?currpage=${currpages+1 }" onclick="">下一页</a><a
                                    href="investRecord.do?currpage=${totalpage }"
                                    onclick="">尾页</a>&nbsp;<em>共${totalpage }页&nbsp;</em></span></div>
