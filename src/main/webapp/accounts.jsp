    ...
    <div class="w1200 personal">
        <div id="personal-left" class="personal-left">
            <ul>
                ...
                <li class=""><span><a style="font-size:14px;text-align:center;width:115px;padding-right:35px;"
                                      href="<%=basePath %>/invest/investRecord.do">投资记录</a></span></li>
                <li class=""><span><a style="font-size:14px;text-align:center;width:115px;padding-right:35px;"
                ...
                <li style="position:relative;" class=""><span> <a href="个人中心-我的红包.html"> <i class="dot dot06"></i> 我的红包 </a> </span>
                </li>
                <li class=""><span><a style="font-size:14px;text-align:center;width:115px;padding-right:35px;"
                                      href="个人中心-兑换历史.html">兑换历史</a></span></li>
                <li style="position:relative;"><span> <a href="个人中心-系统消息.html"><i
                        class="dot dot08"></i>系统信息 </a> </span></li>
        ...
        <div class="personal-main">
          ...
          <div class="investnote-list">
            <div class="investnote-contitle"> <span class="investnote-w1 fb">交易时间</span> <span class="investnote-w2 fb">项目</span> <span
                    class="investnote-w3 fb">状态</span> <span class="investnote-hbw4 fb">我的投资</span> <span
                    class="investnote-hbw5 fb">我的收益</span> <span class="investnote-hbw6 fb">操作</span> </div>
            <ul>
              <li><span class="investnote-w1">2015-10-1</span><span class="investnote-w2">债权转让</span><span
                      class="investnote-w3">已还款</span><span class="investnote-hbw4">12000.00</span> <span
                      class="investnote-hbw5">12000.00</span> <span class="investnote-hbw6"><a
                      href="#">删除</a></span></li>
              <li><span class="investnote-w1">2015-10-1</span><span class="investnote-w2">债权转让</span><span
                      class="investnote-w3">已还款</span><span class="investnote-hbw4">12000.00</span> <span
                      class="investnote-hbw5">12000.00</span> <span class="investnote-hbw6"><a
...
<div class="personal-main">
    <div class="personal-zhsz">
        ...
        <div class="personal-level"><span class="wzd">您的账户完整度</span>
            <i class="grzxbg level3"
               style="border: none; margin: 37px 0px 0px 20px; height: 17px; background-position: 0px -550px;"></i>
            <span class="state">[中]
        ...
        <ul>
            <li><i class="grzxbg p-right"></i><span class="zhsz-span1">手机号</span>
             ...
             %>
         	<%=str %>
          </span><span class="zhsz-span3"><a href="javascript:void(0)" onclick="showSpan('alert-checkOldMobile')">更改</a></span>
            </li>
            ...
            <li><i class="grzxbg p-right"></i><span class="zhsz-span1">登录密码</span><span class="zhsz-span2"></span><span
                    class="zhsz-span3"><a href="javascript:void(0)" onclick="showSpan('alert-updatePass')">更改</a></span>
            </li>
        </ul>
    </div>
</div>
...
<div class="alert-450" id="alert-checkMobile" style="display:none;">
    ...
    <div class="alert-main">
        <form id="checkMonbileForm" name="checkMonbileForm" method="post" action="#"
            ...
            <ul>
                <li>
                    ...
                    <span class="txt240">
              <input id="checkMonbileForm:mobileNumber" type="text" name="checkMonbileForm:mobileNumber"
                     autocomplete="off" value="15055100139" class="txt240" maxlength="35"
                ...
                <li>
                    ...
                    <input id="checkMonbileForm:authCode" type="text" name="checkMonbileForm:authCode" class="txt110"
                           maxlength="8"
                           onblur="jsf.util.chain(this,event,'return checkCheckMobileFormAuthCode()','mojarra.ab(this,event,\'blur\',0,\'@this\')')"
                           placeholder="请输入验证码">
                    <span id="sendCode"><a id="checkMonbileForm:sendAuthCodeBtn" href="#"
                                           ...
                                           class="btn-code">免费获取校验码</a><a id="checkMonbileForm:sendAuthCodeBtn4"
                                                                          href="#" style="display:none;"
                                                                          onclick="mojarra.ab(this,event,'action','@this checkMonbileForm:mobileNumber',0,{'onevent':sCode2});return false"
                                                                          class="btn-code">免费获取校验码</a> </span> <span
                        id="sendCodeGrey" style="display:none;"> <a href="#" id="sendAuthCodeBtn1" class="btn-codeAfter"
                                                                    style="cursor:default;">免费获取校验码</a> </span></li>
                <li>
                    <div id="authCodeErrorDiv" class="errorplace"></div>
                    <div id="authCodeMsg7" style="display:none;" class="yzmplace"> 验证码已发送到您手机<span
                            id="mobileMsg7"></span>，如果收不到短信，请 <a id="checkMonbileForm:sendAuthCodeBtn11" href="#"
                                                                 style="color:blue;"
                    ...
                    <div id="authCodeMsg8" style="display:none;" class="yzmplace"> 您的手机<span id="mobileMsg8"></span>将在60秒内收到语音电话，请接听！
                    </div>
                    <input type="submit" name="checkMonbileForm:j_idt119" value="确　认" class="btn-ok txt-right"
...
<div class="alert-450" id="alert-checkOldMobile" style="display:none;">
    ...
    <div class="alert-main">
        <form id="checkOldMobileForm" name="checkOldMobileForm" method="post" action="#"
              enctype="application/x-www-form-urlencoded">
            ...
            <ul>
                ...
                <li>
                    <label class="txt-name">验证码</label>
                    <input id="checkOldMobileForm:checkOldMobileFormauthCode" type="text"
                           name="checkOldMobileForm:checkOldMobileFormauthCode" class="txt110" maxlength="8"
                           onblur="jsf.util.chain(this,event,'return checkOldMobileFormAuthCode()','mojarra.ab(this,event,\'blur\',0,\'@this\')')"
                           onfocus="clearValue(this)" placeholder="请输入验证码">
                ...
                <li><span class="txt-right" style="display:none;"><i class="error-icon"></i><i class="error-tip">验证码错误请重新输入</i></span><br>
                    <input type="submit" name="checkOldMobileForm:j_idt129" value="确 认" class="btn-ok txt-right"
                           onclick="return checkCheckOldMobileAll()">
                </li>
            </ul>
            <input type="hidden" name="javax.faces.ViewState" id="javax.faces.ViewState"
                   value="6247899183375709698:8256389782682127070" autocomplete="off">
        </form>
    </div>
</div>
<script type="text/javascript">
...
<div class="alert-450" id="alert-updateMobile" style="display:none;">
    ...
    <div class="alert-main">
        <form id="updateMonbileForm" name="updateMonbileForm" method="post" action="/user/managemyInfo"
              enctype="application/x-www-form-urlencoded">
            <input type="hidden" name="updateMonbileForm" value="updateMonbileForm">
            <ul>
                <li>
                    <label class="txt-name">新手机号</label>
                    <input id="updateMonbileForm:mobileNumber2" type="text" name="updateMonbileForm:mobileNumber2"
                           autocomplete="off" value="15055100139" class="txt240" maxlength="35"
                ...
                <li>
                    <label class="txt-name">验证码</label>
                    <input id="updateMonbileForm:updateMonbileFormauthCode" type="text"
                           name="updateMonbileForm:updateMonbileFormauthCode" class="txt110" maxlength="8"
                           onblur="jsf.util.chain(this,event,'return checkUpdateMonbileFormAuthCode()','mojarra.ab(this,event,\'blur\',0,\'@this\')')"
                           onfocus="clearValue(this)" placeholder="请输入验证码">
                    <span id="sendCode1"><a id="updateMonbileForm:sendAuthCodeBtn" href="#"
                                            ...
                                            class="btn-code">免费获取校验码</a><a id="updateMonbileForm:sendAuthCodeBtn5"
                                                                           href="#" style="display:none;"
                                                                           onclick="mojarra.ab(this,event,'action','updateMonbileForm:mobileNumber2',0,{'onevent':sCode4()});return false"
                                                                           class="btn-code">免费获取校验码</a> </span> <span
                        id="sendCodeGrey1" style="display:none;"> <a href="#" id="sendAuthCodeBtn2"
                                                                     class="btn-codeAfter" style="cursor:default;">免费获取校验码</a> </span>
                    <div id="updateMonbileFormauthCodeErrorDiv" class="alert-error120"></div>
                    <div id="authCodeMsg3" style="display:none;" class="yzmplace"> 验证码已发送到您手机<span
                            id="mobileMsg3"></span>，如果收不到短信，请 <a id="updateMonbileForm:sendAuthCodeBtn9" href="#"
                                                                 style="color:blue;"
                    ...
                    <div id="authCodeMsg4" style="display:none;" class="yzmplace"> 您的手机<span id="mobileMsg4"></span>将在60秒内收到语音电话，请接听！
                    </div>
                </li>
                <li><span class="txt-right" style="display:none;"><i class="error-icon"></i><i class="error-tip">验证码错误请重新输入</i></span>
                    <input type="submit" name="updateMonbileForm:j_idt139" value="确 认" class="btn-ok txt-right"
                           onclick="return updateMobileAll()">
                </li>
            </ul>
            <input type="hidden" name="javax.faces.ViewState" id="javax.faces.ViewState"
                   value="6247899183375709698:8256389782682127070" autocomplete="off">
...
<div class="alert-450" id="alert-identity" style="display:none;">
    ...
    <div class="alert-main">
        <form id="" name="checkOldMobileForm" method="post" action="<%=basePath%>/insertUsercre.do"
              enctype="application/x-www-form-urlencoded">
            ...
            <ul>
                <li>
                    ...
                    <input id="realname" type="text" onblur="identity('1')" name="realname" class="txt235"
                           placeholder="请输入真实姓名">
                </li>
                <li>
                ...
                <li>
                    ...
                    <input id="idnumber" type="text" onblur="idcarid('2')" name="idnumbers" class="txt235"
                           placeholder="请输入身份证号">
                </li>
                <li>
...
<div class="alert-450" id="alert-updateEmail" style="display:none;">
    ...
    <div class="alert-main" id="alert-main">
        <form id="changeEmailForm" name="changeEmailForm" method="post" action="/user/managemyInfo"
              enctype="application/x-www-form-urlencoded">
            ...
            <ul>
                <li>
                    ...
                    <input id="changeEmailForm:newEmail" type="text" name="changeEmailForm:newEmail" class="txt235"
                ...
                <li>
                    ...
                    <input id="changeEmailForm:changeEmailFormauthCode" type="text"
                           name="changeEmailForm:changeEmailFormauthCode" class="txt110" maxlength="8"
                           onblur="mojarra.ab(this,event,'blur',0,0)" placeholder="请输入手机验证码">
                    <span id="sendCode2"><a id="changeEmailForm:sendAuthCodeBtn" href="#"
                                            ...
                                            class="btn-code">免费获取校验码</a><a id="changeEmailForm:sendAuthCodeBtn6"
                                                                           href="#" style="display:none;"
                                                                           onclick="mojarra.ab(this,event,'action','@this changeEmailForm:newEmail',0,{'onevent':sCode3});return false"
                                                                           class="btn-code">免费获取校验码</a> </span> <span
                        id="sendCodeGrey2" style="display:none;"> <a href="#" id="sendAuthCodeBtn3"
                                                                     class="btn-codeAfter" style="cursor:default;">免费获取校验码</a> </span>
                </li>
                <li>
                    <div id="changeEmailFormauthCodeErrorDiv" class="errorplace"></div>
                    <div id="authCodeMsg5" style="display:none;" class="yzmplace1"> 验证码已发送到您手机<span
                            id="mobileMsg5"></span>，如果收不到短信，请 <a id="changeEmailForm:sendAuthCodeBtn4" href="#"
                                                                 style="color:blue;"
                    ...
                    <div id="authCodeMsg6" style="display:none;" class="yzmplace1"> 您的手机<span id="mobileMsg6"></span>将在60秒内收到语音电话，请接听！
                    </div>
                    <input type="submit" name="changeEmailForm:j_idt150" value="确　认" class="btn-ok txt-right"
    ...
    <div class="alert-main" id="alert-main2" style="display:none;text-align:center;">
        <div class="about-con">
            <ul>
                ...
                <li>
                    <input type="submit" name="j_idt153" value="确认" style="margin:20px 0 20px 80px;"
                           class="btn-ok txt-right2" onclick="displaySpan2()">
                </li>
            </ul>
        </div>
    </div>
        ...
        <form id="bandingEmail" name="bandingEmail" method="post" action="" enctype="application/x-www-form-urlencoded">
            <ul>
                <li>
                    ...
                    <input id="bandingEmail:bandingEmailemail" type="text" name="bandingEmail:bandingEmailemail"
                           value="348705622@qq.com" class="txt235"
                ...
                <input type="submit" name="bandingEmail:j_idt158" value="确认并激活邮箱" class="btn-ok txt-right"
                       onclick="return bandingEmailAll()">
            </ul>
        </form>
    </div>
</div>
        ...
        <form id="activeEmail" name="activeEmail" method="post" action="" enctype="application/x-www-form-urlencoded">
            <ul>
                <li>
                    ...
                    <input id="activeEmail:activeEmailemail" type="text" name="activeEmail:activeEmailemail"
                           value="348705622@qq.com" class="txt235"
                ...
                <input type="submit" name="activeEmail:j_idt163" value="立即激活邮箱" class="btn-ok txt-right"
                       onclick="return checkActiveEmailAll()"></input>
            </ul>
        </form>
    </div>
</div>
<div class="alert-450 alert-h220" id="alert-activeEmailMsg" style="display:none;">
    ...
    <div class="alert-main">
        <form id="activeEmailMsg" name="activeEmailMsg" method="post" action=""
...
<div class="alert-450" id="alert-updatePass" style="display: none;">
    ...
    <div class="alert-main">
        <form id="updatePassForm" name="updatePassForm" method="post" action="<%=basePath%>/updpassword.do"
              enctype="application/x-www-form-urlencoded">
            ...
            <ul>
                <li>
                    ...
                    <input id="oldPassword" type="password" name="updatePassForm:oldPassword" value="" maxlength="20"
                           onblur="password();" class="txt235">
                ...
                <li>
                    ...
                    <input id="updatePassForm:password" type="password" name="updatePassForm:password" value=""
                           maxlength="20"
                ...
                <li>
                    ...
                    <input id="updatePassForm:repassword" type="password" name="updatePassForm:repassword" value=""
