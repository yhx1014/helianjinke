     ...
     <form action="<%=basePath%>brower/insert.do" method="post">
		<div class="layui-form-item">
		    ...
		    <div class="layui-input-block">
		      <select name="bmortgagetype" lay-verify="required">
	     ...
	     <div class="layui-form-item">
             ...
             <div class="layui-input-block">
             <input type="text" name="bmortgagecount" lay-verify="title" autocomplete="off" placeholder="请输入数量" class="layui-input">
         </div>
        </div>
        <div class="layui-form-item">
		    <label class="layui-form-label">还款方式</label>
		    <div class="layui-input-block">
		      <select name="bpaytype" lay-verify="required">
		 ...
		 <div class="layui-form-item">
		    ...
		    <div class="layui-input-block">
		      <select name="bcommission" lay-verify="required">
		 ...
		 <div class="layui-form-item">
             ...
             <div class="layui-input-block">
             <input type="text" name="bcount" lay-verify="title" autocomplete="off" placeholder="请输入数量" class="layui-input">
             </div>
         </div>
        <div class="layui-form-item">
		    <label class="layui-form-label">借款期限</label>
		    <div class="layui-input-block">
		      <select name="binterval" lay-verify="required">
		 ...
		 <div class="layui-form-item">
		    ...
		    <div class="layui-input-block">
		      <select name="brate" lay-verify="required">
		        <option value="0">10</option>
		        <option value="1">20</option>
