				...
				<div class="pmain-money">
					<ul>
						<li class="none"><span><em>账户总额</em><i id="zhze"
								...
								class="f26 fb">${count.totalcount}</i> 元</span></li>
						<li><span><em>待收本息</em><i id="dsbx" class="markicon"></i><span
							...
							class="truemoney"><i class="f26 fb">${count.type}</i>元</span></li>
						<li><span><em>累计收益</em><i id="ljsy" class="markicon"></i><span
							...
							class="truemoney"><i class="f26 fb c-pink">${count.totalcount}</i>
								元</span></li>
					</ul>
				</div>
