...
<div class="wrapper wbgcolor">
        ...
        <div class="quick-pay-wrap">
          <h4> <span class="quick-tit pay-cur"><em>地址充值</em></span> 
               <span class="online-tit"><em>二维码充值</em></span> </h4>
            ...
            <div class="quick-main">
              <div class="fl quick-info">
                <div class="info-1"> <span class="info-tit">充值金额</span> <span class="info1-input">
                  ...
                  <em>ETH</em> </span> <span class="quick-error"> </span> </div>
                <div class="info-tips">币币袋提醒您：</div>
                <div class="info-2"> <span class="info-tit">充值地址</span> 
                  <span class="quick-error3" id="bankCardError">充值地址是0x</span> 
                </div>
                <div class="bank-check" id="bank-check2"> <b class="selected" id="bankProtocol1"></b><span class="bank-agree">我同意并接受<a href="#" target="_blank">《币币袋咨询与管理服务电子协议》</a></span> <span class="error" id="bankProtocol_message" style="display:none;margin-top:-3px;">请同意协议内容！</span> </div>
              ...
              <div class="online-mar">
                <div class="quick-info quick-info-width">
                  <div class="info-1"> <span class="info-tit">充值金额</span> <span class="info1-input">
                    ...
                    <em>ETH</em> </span> <span id="actualMoneyErrorDiv" class="quick-error2"> </span> 
                  </div>
                </div>
              </div>
              <div> <span><font style=" color:#848484;font-weight:bold; margin-left:80px; height:32px; line-height:32px; font-size:12px;">亿人宝提醒您：充值前，请核实您的额度！</font></span> </div>
              <div class="pay-bank" id="pay-bank">
                <h6>二维码地址</h6>
                <span id="showpay" style="display:none;">icbc</span>
                <ul id="paysSpan" style="height:200px;">
                  <li><img src="images/bank.png" property1="cib"><em></em></li>
                </ul>
                </div>
              <div class="bank-check" id="bank-check"> <b class="selected" id="bankProtocol"></b><span class="bank-agree">我同意并接受<a href="/node/Candyprivacypolicy/candyprivacypolicy_tzzxyglfwdzxy" target="_blank">《币币袋咨询与管理服务电子协议》</a></span> 
              <span class="error" id="bankProtocol_message" style="display:none;margin-top:-3px;">请同意协议内容！</span> 
              </div>
          ...
          <div class="pay-tipcon" style="display:none;"> <b>充值提示：</b><br>
            1．币币袋充值过程免费，不向用户收取任何手续费。<br>
            2．为了您的账户安全，请在充值前进行身份认证、手机绑定以及交易密码设置。<br>
            3．如果充值金额没有及时到账，请联系客服-04764900000 </div>
