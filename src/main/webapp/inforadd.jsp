...
<head>
    ...
    <script type="text/javascript" src="<%=basePath%>/script/ablumn.js"></script>
...
<script type="text/javascript">
    ...
    function reckon() {//动态算出预期收益
        var money = document.getElementById("amount").value;
        var getm = parseInt(money) + (${Borrowmoney.pincome } * (${days} / 365) * money) /
        100;
            ...
            <div class="data">
                <ul>
                    ...
                    <li class="colspan"><span class="c-888 fl">投标进度：</span>
                        ...
                        <span class="c-green">${(Borrowmoney.pmoney/Borrowmoney.ptotalmoney)*(100)}%</span>
                    </li>
                                        ...
                                        <div
                                            ...
                                            <ul
                                                ...
                                                <c:forEach items="${Details }" var="dt">
                                                    <c:if test="${dt.dtype==2 }">
                                                        <li
                                                                style="overflow: hidden; float: left; width: 164px; height: 108px;">
                                                            <a
                            ...
                            <c:forEach items="${record }" var="record">
                                <tr>
                                    <td>${fn:substring(record.uname,0,1)}
                                        <c:forEach begin="1"
                                                   end="${fn:length(fn:substring(record.uname,1,fn:length(record.uname)))}"
                                                   step="1">
                                            *
                                        </c:forEach>
                                    </td>
