...
$(function () {
    ...
    $("#abouticon li.icon1").hover(
        function () {
            $(this).removeClass("icon1").addClass("on-icon1");
        },
        function () {
            $(this).removeClass("on-icon1").addClass("icon1");
        }
    )
    $("#abouticon li.icon2").hover(
        function () {
            $(this).removeClass("icon2").addClass("on-icon2");
        },
        function () {
            $(this).removeClass("on-icon2").addClass("icon2");
        }
    )

    $("#abouticon li.icon3").hover(
        function () {
            $(this).removeClass("icon3").addClass("on-icon3");
        }, function () {
            $(this).removeClass("on-icon3").addClass("icon3");
        })
    $("#abouticon li.icon4").hover(
        function () {
            $(this).removeClass("icon4").addClass("on-icon4");
        }, function () {
            $(this).removeClass("on-icon4").addClass("icon4");
        })
