			...
			<div class="bd clearfix">
				<div class="data">
					<ul>
						...
						<li><span class="f16">借币期限</span><br> 
						<span class="f30 c-333">
							<fmt:formatDate value="${Borrowmoney.pcount }" pattern="yyyy-MM-dd" /></span></li>
						...
						<li class="colspan">
							...
							<div class="progress-bar fl">
							    ...
							    <span class="c-green"> <fmt:formatNumber value="${(Borrowmoney.pmoney/Borrowmoney.ptotalmoney)*(100)}" pattern="#.##"/>%</span>
						</li>
						<li><span class="c-888">投资范围：</span> 
						<span id="account_range">${Borrowmoney.prange} </span></li>
					</ul>
				</div>
			</div>
		</div>
			...
			<div class="bd">
				...
				<div class="ui-tab-item" style="display: none;">
					<div class="repayment-list">
						...
						<table style="width:100%;border:0;cellspacing:0;cellpadding:0px;">
							<tbody>
								<tr>
									<th>合约还款日期</th>
									<th>期数</th>
