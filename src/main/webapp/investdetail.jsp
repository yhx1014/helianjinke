...
<head>
    ...
    <script type="text/javascript">
        $(document).ready(
            function () {
                $("#personal-left li:first").removeClass("pleft-cur");
                $("#personal-left li:last").addClass("pleft-cur");
            }
        )
    </script>
</head>
        ...
        <div class="pmain-profile" style="padding: 10px">
            ...
            <div style="margin-bottom: 20px">
                ...
                <div id="page_nav_area">
                    <div class="page_bar">
                        <span><a href="<%=basePath%>/orders?pn=1">首页</a></span>
                        <span><a href="">1</a></span>
                        <span><a href="">2</a></span>
                        <span><a href="" class="active">3</a></span>
                        <span><a href="">4</a></span>
                        <c:if test="${pageInfo.hasPreviousPage}">
                            <span><a href="<%=basePath%>/orders?pn=${pageInfo.pageNum-1}"><</a></span>
                        </c:if>
                        <c:forEach items="${pageInfo.navigatepageNums }" var="page_Num">
                            ...
                            <c:if test="${page_Num != pageInfo.pageNum }">
                                <span><a href="<%=basePath%>/orders?pn=${page_Num}">${page_Num }</a></span>
                            </c:if>
                        </c:forEach>
                        <c:if test="${pageInfo.hasNextPage}">
                            <span><a href="<%=basePath%>/orders?pn=${pageInfo.pageNum+1}">> </a></span>
                        </c:if>
                        <span><a href="<%=basePath%>/orders?pn=${pageInfo.endRow}">尾页</a></span>
                    </div>
                </div>
            </div>
